...
public class Arm extends SubsystemBase {
    ...
    public final LoggedInternalButton isAtPos = new LoggedInternalButton("Arm/At Position");
    ...
    public Command genCommand(String name, Supplier<Measure<AngleUnit>> posSupplier) {
        ...
        return new Command() {
            ...
            @Override
            public void execute() {
                var pos = posSupplier.get().plus(offset);
                isAtPos.setPressed(MathUtil.isNear(
                    pos.in(Degrees),
